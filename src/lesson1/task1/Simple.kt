 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = ((sagenes * 213.36) + (arshins * 71.12) + (vershoks * 4.445)) / 100
...
fun accountInThreeYears(initial: Int, percent: Int): Double{
    val firstYear = initial.toDouble() + initial.toDouble() / 100 * percent.toDouble()
    val secondYear = firstYear + firstYear / 100 * percent.toDouble()
    val thirdYear = secondYear + secondYear / 100 * percent.toDouble()
    return thirdYear
}
